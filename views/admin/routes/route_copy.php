<?php
	...
	$content.="<form role='form' method='post' action='" . pagelink('route_copy',$language_id) . "'>";
		...
		$content.="<div class='modal-footer'>";
			$content.="<button type='submit' class='btn btn-primary'>". ucfirst(translate("copy")) ."</button>";
