<?php
	...
	$content.="<div class='panel-heading'>" . ucfirst(translate('language_edit')) . "</div>";
	$content.="<div class='panel-body'>";
	$content.="<input type='hidden' name='form_action' value='language_edit'/>";
	...
	$content.="<input name='name' id='name' type='text' class='form-control' value='" . $language->name . "' required/>";
	$content.="</div>";
	$content.="</div>";
	//end
	...
	$content.="<div class='col-md-6'>";
	$content.="<input name='shortname' id='shortname' type='text' class='form-control' value='" . $language->shortname . "' required/>";
	$content.="</div>";
	$content.="</div>";
	//end
	...
	if($language->active==1){
		...
		$content.="<label><input type='checkbox' name='active' id='active' />" . ucfirst(translate('language_active')) . "</label>";
	}
	$content.="</div>";
   	$content.="</div>";
	$content.="</div>";
