<?php
$content.="<form role='form' method='post' action='" . actionlink('ProfileController@userright_add',$active_pagemeta->id) . "'>";
	...
	$content.="<div class='modal-body'>";
		...
		$content.="<input type='hidden' name='form_action' value='userright_add'>";
